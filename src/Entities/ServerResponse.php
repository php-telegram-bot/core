...
class ServerResponse extends Entity
{
    ...
    private function createResultObject(array $result, string $bot_username): Entity
    {
        $result_object_types = [
            ...
            'createChatSubscriptionInviteLink' => ChatInviteLink::class,
            'editChatSubscriptionInviteLink'   => ChatInviteLink::class,
            'uploadStickerFile'               => File::class,
            'getMyStarBalance'                => StarAmount::class,
            'getBusinessAccountStarBalance'   => StarAmount::class,
            'getUserProfileAudios'            => UserProfileAudios::class,
            'getStarTransactions'             => StarTransactions::class,
            'getUserGifts'                    => OwnedGifts::class,
            'getChatGifts'                    => OwnedGifts::class,
            'getBusinessAccountGifts'         => OwnedGifts::class,
            'getAvailableGifts'               => Gifts::class,
            'createForumTopic'                => ForumTopic::class,
            'savePreparedInlineMessage'       => PreparedInlineMessage::class,
            'postStory'                       => Story::class,
            'editStory'                       => Story::class,
            'repostStory'                     => Story::class,
        ];
