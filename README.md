...
[![API Version](https://img.shields.io/badge/Bot%20API-6.5%20%28February%20322%29-32a2da.svg)](https://core.telegram.org/bots/api-changelog#february-3-2023)
...
- Supports all types and methods according to Telegram Bot API 6.5 (February 2023).
...
All types are implemented according to Telegram API 6.5 (February 2023).

### Inline Query

Full support for inline query according to Telegram API 6.5 (February 2023).

### Methods

All methods are implemented according to Telegram API 6.5 (February 2023).
