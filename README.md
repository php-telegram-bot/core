...
[![API Version](https://img.shields.io/badge/Bot%20API-6.4%20%28December%203022%29-32a2da.svg)](https://core.telegram.org/bots/api-changelog#december-30-2022)
...
- Supports all types and methods according to Telegram Bot API 6.4 (December 2022).
...
All types are implemented according to Telegram API 6.4 (December 2022).

### Inline Query

Full support for inline query according to Telegram API 6.4 (December 2022).

### Methods

All methods are implemented according to Telegram API 6.4 (December 2022).
